...
REPORT_PROMPT = ChatPromptTemplate.from_messages([
    ("system",
     ...
     "Use simple semantic HTML only: h1, h2, h3, p, ul, li, table, tr, th, td, strong, em. "
     "Do not wrap the output in markdown code fences. "
     "Use headings, compact tables, and bullets. Keep table cells short and readable. "
     "Highlight risk and safe metrics with clear labels in the text rather than relying only on color.\n\n"
     ...
     "2. Baseline KPIs vs Scenario KPIs (side-by-side HTML table with columns: Metric, Baseline, Scenario, Change, Interpretation)\n"
